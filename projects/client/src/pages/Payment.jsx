            ...
            <Box mt={"100px"}>
                <Stack>
                    ...
                    <Box
                        ...
                        py={2}
                    >
                        Please make a payment to the account number below and
                        upload proof in the available form before the time run
                        out
                    </Box>
                    ...
                    <Accordion>
                        <AccordionItem>
                            <AccordionButton
                                _expanded={{ bg: "#81B29A", color: "white" }}
                            >
                    ...
                    >
                        {formik?.values?.payment_proof_img?.name ||
                            "Upload Payment"}
                    </Button>
